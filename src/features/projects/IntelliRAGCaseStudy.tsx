...
import { IntelliRAGDiagram } from './IntelliRAGDiagram';
import { Button } from '../../components/Button';
import { ArrowLeft } from 'lucide-react';
import intelliragMarkdown from '../../content/projects/intellirag.md?raw';

export const IntelliRAGCaseStudy: React.FC = () => {
  const { frontmatter, content } = parseMarkdown(intelliragMarkdown);
