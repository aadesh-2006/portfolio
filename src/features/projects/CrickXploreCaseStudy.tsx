...
import { CrickXploreDiagram } from './CrickXploreDiagram';
import { Button } from '../../components/Button';
import { ArrowLeft } from 'lucide-react';
import crickxploreMarkdown from '../../content/projects/crickxplore.md?raw';

export const CrickXploreCaseStudy: React.FC = () => {
  const { frontmatter, content } = parseMarkdown(crickxploreMarkdown);
          ...
          <div className="space-y-6">
            ...
            <div className="border border-border-grid rounded-[4px] bg-surface-bg p-4 space-y-4">
              ...
              <div className="flex flex-col gap-2">
                <Button 
                  variant="secondary" 
                  href="https://github.com/aadesh-2006/CrickXplore" 
