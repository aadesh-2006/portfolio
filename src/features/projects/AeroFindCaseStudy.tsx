...
import { AeroFindDiagram } from './AeroFindDiagram';
import { Button } from '../../components/Button';
import { ArrowLeft } from 'lucide-react';
import aerofindMarkdown from '../../content/projects/aerofind.md?raw';

export const AeroFindCaseStudy: React.FC = () => {
  const { frontmatter, content } = parseMarkdown(aerofindMarkdown);
