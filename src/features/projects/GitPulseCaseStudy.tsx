...
import { GitPulseDiagram } from './GitPulseDiagram';
import { Button } from '../../components/Button';
import { ArrowLeft } from 'lucide-react';
import gitpulseMarkdown from '../../content/projects/gitpulse.md?raw';

export const GitPulseCaseStudy: React.FC = () => {
  const { frontmatter, content } = parseMarkdown(gitpulseMarkdown);
          ...
          <div className="space-y-6">
            ...
            <div className="border border-border-grid rounded-[4px] bg-surface-bg p-4 space-y-4">
              ...
              <div className="flex flex-col gap-2">
                <Button 
                  variant="secondary" 
                  href="https://github.com/aadesh-2006/GitPulse" 
