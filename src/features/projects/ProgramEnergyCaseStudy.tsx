...
import { ProgramEnergyDiagram } from './ProgramEnergyDiagram';
import { Button } from '../../components/Button';
import { ArrowLeft } from 'lucide-react';
import programenergyMarkdown from '../../content/projects/programenergy.md?raw';

export const ProgramEnergyCaseStudy: React.FC = () => {
  const { frontmatter, content } = parseMarkdown(programenergyMarkdown);
