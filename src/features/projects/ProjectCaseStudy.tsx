...
import { FlowSyncDiagram } from './FlowSyncDiagram';
import { Button } from '../../components/Button';
import { ArrowLeft } from 'lucide-react';
import flowsyncMarkdown from '../../content/projects/flowsync.md?raw';

export const ProjectCaseStudy: React.FC = () => {
  const { frontmatter, content } = parseMarkdown(flowsyncMarkdown);
