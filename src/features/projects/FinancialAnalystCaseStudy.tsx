...
import { FinancialAnalystDiagram } from './FinancialAnalystDiagram';
import { Button } from '../../components/Button';
import { ArrowLeft } from 'lucide-react';
import financialAnalystMarkdown from '../../content/projects/ai-financial-research-analyst.md?raw';

export const FinancialAnalystCaseStudy: React.FC = () => {
  const { frontmatter, content } = parseMarkdown(financialAnalystMarkdown);
          ...
          <div className="space-y-6">
            ...
            <div className="border border-border-grid rounded-[4px] bg-surface-bg p-4 space-y-4">
              ...
              <div className="flex flex-col gap-2">
                <Button 
                  variant="secondary" 
                  href="https://github.com/aadesh-2006/ai-financial-research-analyst" 
