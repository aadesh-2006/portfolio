...
import { PeerBridgeDiagram } from './PeerBridgeDiagram';
import { Button } from '../../components/Button';
import { ArrowLeft } from 'lucide-react';
import peerbridgeMarkdown from '../../content/projects/peerbridge.md?raw';

export const PeerBridgeCaseStudy: React.FC = () => {
  const { frontmatter, content } = parseMarkdown(peerbridgeMarkdown);
