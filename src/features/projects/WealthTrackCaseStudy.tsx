...
import { WealthTrackDiagram } from './WealthTrackDiagram';
import { Button } from '../../components/Button';
import { ArrowLeft } from 'lucide-react';
import wealthtrackMarkdown from '../../content/projects/wealthtrack.md?raw';

export const WealthTrackCaseStudy: React.FC = () => {
  const { frontmatter, content } = parseMarkdown(wealthtrackMarkdown);
